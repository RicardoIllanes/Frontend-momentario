                ...
                <div className="md:col-span-2 space-y-4">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="text-sm text-zinc-500">Año {reserva.vehiculo?.anio}</p>
                        </div>
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${getEstadoBadgeColor(reserva.estado?.estado)}`}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="text-xs text-zinc-500 uppercase tracking-wider mb-1">Fecha Reserva</p>
                            <p className="font-semibold text-zinc-900">{formatDate(reserva.fechaReserva)}</p>
                        </div>
                        <div>
                            <p className="text-xs text-zinc-500 uppercase tracking-wider mb-1">Fecha Entrega</p>
                            <p className="font-semibold text-zinc-900">{formatDate(reserva.fechaEntrega)}</p>
                        </div>
                    </div>

                    <div className="flex justify-between items-center pt-4 border-t border-zinc-100">
                        <div>
                            <p className="text-xs text-zinc-500 mb-1">Precio de Reserva</p>
